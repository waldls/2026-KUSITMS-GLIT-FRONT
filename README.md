...
> 하루 5분 커리어 기록 서비스 **GLIT**의 프론트엔드 레포지토리.
...
| **Styling**              | Tailwind CSS v4 / PostCSS / Stylelint               |
| **상태 관리**            | Zustand 5 / TanStack Query v5                       |
| **HTTP**                 | ky v2                                               |
| **PWA / 알림**           | Next.js manifest.ts / Firebase FCM                  |
| **패키지 관리**          | pnpm 10                                             |
| **UI 라이브러리**        | Recharts / Swiper / react-day-picker / lottie-react |
| **Infra / CI-CD**        | GitHub Actions / Vercel                             |
